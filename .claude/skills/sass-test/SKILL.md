...
| snapshot (`meta/` examples) | its output cannot change unnoticed | 78/78 members |
| rejection (`meta/` rejects) | bad input is refused, with the library's own message | 56/78 |
