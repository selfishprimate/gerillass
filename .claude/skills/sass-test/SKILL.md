...
| snapshot (`meta/` examples) | its output cannot change unnoticed | 74/74 members |
| rejection (`meta/` rejects) | bad input is refused, with the library's own message | 45/74 |
| **sass-true spec** | **the CSS is correct** | **11/74** |
