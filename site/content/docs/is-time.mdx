...
page_description: "The isTime Sass function returns the value when it is a time in s or ms, and errors otherwise, so an animation argument is checked before it is used."
