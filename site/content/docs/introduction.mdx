...
page_description: "Gerillass is a Sass library of 56 mixins and 24 functions with a machine readable manifest its own test suite compiles, so an agent cannot be misled."
...
**Gerillass** is a toolkit of Sass mixins and functions: 56 mixins and 24
...
than one declaration. That is the bar, and it is why the library is 56 mixins
rather than 200.
