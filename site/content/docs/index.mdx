...
title: "Installation"
guide: true
page_title: "Installing Gerillass"
page_description: "How to install Gerillass and load it in Vite, webpack, Next.js, Angular, Gulp, Grunt or Dart Sass on its own, plus the three ways to call a mixin and what an AI coding agent needs to use the library correctly."
