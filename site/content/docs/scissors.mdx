...
<Arguments of="scissors" footnote="You can use <code>0</code> or <code>null</code> to skip styling the related corner.">
...
<Example caption="You can use <code>null</code> to skip a corner as well! The following arrangement will target only the bottom corners.">
```scss
.element{
