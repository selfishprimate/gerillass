...
```html
<style>
  .card { width: 240px; background: #fff; color: #18181b; border: 1px solid #e4e4e7; line-height: 1.4; }
  .card .title { font-weight: 600; }
  .card .pill { background: #dcfce7; color: #166534; font-weight: 500; }
</style>
<div class="card">
...
```html
<style>
  .tag { display: inline-block; padding: 4px 10px; border-radius: 999px; background: #18181b; color: #fafafa; font: 500 13px/1.4 Inter, ui-sans-serif, system-ui, sans-serif; }
</style>
