...
| `background-pattern($kind: dots, $params...)` | Eighteen background patterns drawn with gradients alone: fifteen that tile, from dots and stripes to houndstooth and harlequin, and glow, vignette and mesh, which light the whole box. |
