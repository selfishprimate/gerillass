...
// Every mixin exists twice, and the gls- half is generated by concatenating
// scss/library into scss/_gerillass-prefix.scss and rewriting "@mixin " to
// "@mixin gls-". Nothing else exercises that output, so a corrupted generator
// would ship silently. Running the same example under both names and demanding
// identical CSS is the check: it fails on a mangled body, a dropped mixin, or a
// validation branch that did not survive the rewrite.
