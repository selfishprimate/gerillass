...
Mixins validate their input and `@error` with a message that names the accepted values — 36 of the 46 that take arguments do this, mostly inline. Match that style rather than failing silently.
