...
// of their own.
const validating = withArgs.filter((f) => /@error|\bvalidate[A-Z]|\bis(?!CssFunction\b)[A-Z][a-z]|\bimageValue\(|\bgradientOf\(|\bcolor(Stops)?Problem\(/.test(read(`scss/library/${f}`)));
